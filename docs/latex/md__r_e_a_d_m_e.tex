...
\hypertarget{md__r_e_a_d_m_e}{}\label{md__r_e_a_d_m_e}\index{OlxAPIWrapper@{OlxAPIWrapper}}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md1}{}\doxysection{\texorpdfstring{Table of Contents}{Table of Contents}}\label{md__r_e_a_d_m_e_autotoc_md1}
...
\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}\+Experimental feature. May ruin Oneliner graphics display. Use with caution.\texorpdfstring{$\ast$}{*}\hypertarget{md__r_e_a_d_m_e_autotoc_md2}{}\doxysection{\texorpdfstring{Requirements}{Requirements}}\label{md__r_e_a_d_m_e_autotoc_md2}
...
\end{DoxyItemize}\hypertarget{md__r_e_a_d_m_e_autotoc_md3}{}\doxysection{\texorpdfstring{Using Olx\+APIWrapper}{Using OlxAPIWrapper}}\label{md__r_e_a_d_m_e_autotoc_md3}
\hypertarget{md__r_e_a_d_m_e_autotoc_md4}{}\doxysubsubsection{\texorpdfstring{Getting Started}{Getting Started}}\label{md__r_e_a_d_m_e_autotoc_md4}
...
Back to top\hypertarget{md__r_e_a_d_m_e_autotoc_md5}{}\doxysubsubsection{\texorpdfstring{Editing Equipment Values}{Editing Equipment Values}}\label{md__r_e_a_d_m_e_autotoc_md5}
...
Back to top\hypertarget{md__r_e_a_d_m_e_autotoc_md6}{}\doxysubsubsection{\texorpdfstring{Get Unique Formatted Object ID String}{Get Unique Formatted Object ID String}}\label{md__r_e_a_d_m_e_autotoc_md6}
...
Back to top\hypertarget{md__r_e_a_d_m_e_autotoc_md7}{}\doxysubsubsection{\texorpdfstring{Edit Graphics Object Values}{Edit Graphics Object Values}}\label{md__r_e_a_d_m_e_autotoc_md7}
This is currently under development, but this will allow the user to get positions of graphics objects within the model. Similar to other API objects, there are {\ttfamily get} and {\ttfamily set} for each graphics object value.\hypertarget{md__r_e_a_d_m_e_autotoc_md8}{}\doxyparagraph{\texorpdfstring{Olx\+APIGraphics\+Type1\+Obj}{OlxAPIGraphicsType1Obj}}\label{md__r_e_a_d_m_e_autotoc_md8}
...
Back to top\hypertarget{md__r_e_a_d_m_e_autotoc_md9}{}\doxyparagraph{\texorpdfstring{Olx\+APIGraphics\+Type2\+Obj}{OlxAPIGraphicsType2Obj}}\label{md__r_e_a_d_m_e_autotoc_md9}
This graphics object is associated with the following devices and has the following properties\+:
...
Back to top\hypertarget{md__r_e_a_d_m_e_autotoc_md10}{}\doxyparagraph{\texorpdfstring{Olx\+APIGraphics\+Type3\+Obj}{OlxAPIGraphicsType3Obj}}\label{md__r_e_a_d_m_e_autotoc_md10}
This graphics object is associated with the following devices and has the following properties\+:
...
Back to top\hypertarget{md__r_e_a_d_m_e_autotoc_md11}{}\doxyparagraph{\texorpdfstring{Olx\+APIGraphics\+Type4\+Obj}{OlxAPIGraphicsType4Obj}}\label{md__r_e_a_d_m_e_autotoc_md11}
This graphics object is associated with the following devices and has the following properties\+:
...
\end{longtabu}
\hypertarget{md__r_e_a_d_m_e_autotoc_md12}{}\doxyparagraph{\texorpdfstring{Olx\+APIGraphics\+Type5\+Obj}{OlxAPIGraphicsType5Obj}}\label{md__r_e_a_d_m_e_autotoc_md12}
This graphics object is associated with the following devices and has the following properties\+:
...
Back to top\hypertarget{md__r_e_a_d_m_e_autotoc_md13}{}\doxysubsubsection{\texorpdfstring{Supported One\+Liner Equipment}{Supported OneLiner Equipment}}\label{md__r_e_a_d_m_e_autotoc_md13}
\tabulinesep=1mm
...
\end{longtabu}
Back to top\hypertarget{md__r_e_a_d_m_e_autotoc_md14}{}\doxysubsection{\texorpdfstring{Using the Example Application}{Using the Example Application}}\label{md__r_e_a_d_m_e_autotoc_md14}
The example application, when compiled, replaces cable lengths, types, and impedances via a lookup routine using the cable names, given that each cable has a unique name.\hypertarget{md__r_e_a_d_m_e_autotoc_md15}{}\doxysubsubsection{\texorpdfstring{Command Line Arguments}{Command Line Arguments}}\label{md__r_e_a_d_m_e_autotoc_md15}

\begin{DoxyCode}{0}
\DoxyCodeLine{>\ ./OlxAPIWrapperTest.exe\ -\/i\ "{}../<input\_model.olr>"{}\ -\/csv\ "{}../<input\_csv.csv>"{}\ -\/o\ "{}./<output\_model.olr>"{}}

\end{DoxyCode}
 This directs the application to open the {\ttfamily input\+\_\+model.\+olr} model file and use the {\ttfamily input\+\_\+csv.\+csv} csv file to replace cable properties. If no {\ttfamily -\/o} is used, the model will be overwritten, therefore the output file is specified to prevent overwriting the same file. Back to top\hypertarget{md__r_e_a_d_m_e_autotoc_md16}{}\doxyparagraph{\texorpdfstring{Other Arguments}{Other Arguments}}\label{md__r_e_a_d_m_e_autotoc_md16}
...
Back to top\hypertarget{md__r_e_a_d_m_e_autotoc_md17}{}\doxysubsubsection{\texorpdfstring{CSV Input File}{CSV Input File}}\label{md__r_e_a_d_m_e_autotoc_md17}
...
\end{longtabu}
Back to top\hypertarget{md__r_e_a_d_m_e_autotoc_md18}{}\doxysubsubsection{\texorpdfstring{TODO}{TODO}}\label{md__r_e_a_d_m_e_autotoc_md18}
